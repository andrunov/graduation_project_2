...
public class UserTestData {
    ...
    public static final User USER_01 = new User("Алексей Иванов","ivanov.alexey@gmail.com","123",Role.REGULAR);
    public static final User USER_02 = new User("Андрей Горбунов","andrunov@gmail.com","456",Role.ADMIN, Role.REGULAR);
    public static final User USER_03 = new User("Павел Сидоров","sidor@gmail.com","789", Role.REGULAR);
    public static final User USER_04 = new User("Roberto Zanetti","rzanetti@gmail.com","101112", Role.REGULAR);
    public static final User USER_05 = new User("John Bon Jovi","jbj@gmail.com","131415", Role.REGULAR);
    public static final User USER_06 = new User("Didier Maoruani","dmauruani@gmail.com","161718", Role.REGULAR);
